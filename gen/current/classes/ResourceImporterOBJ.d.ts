import type { GodotArray, GodotDictionary, ResourceImporter, Vector3, float, int } from "../index.d.ts";
/**
 ...
 */
  forceDisableMeshCompression: boolean;
/**
 * If `true`, generates UV2 on import for `LightmapGI` baking.
 */
  generateLightmapUv2: boolean;
/**
 ...
 */
  generateLightmapUv2TexelSize: float;
/**
