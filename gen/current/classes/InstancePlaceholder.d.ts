import type { GodotArray, GodotDictionary, Node, PackedScene, float, int } from "../index.d.ts";
/**
 ...
 * @param customScene PackedScene (optional, default: null)
 * @returns Node
 */
  createInstance(replace?: boolean, customScene?: PackedScene): Node;
/**
 ...
 * @param withOrder boolean (optional, default: false)
 * @returns GodotDictionary<any>
 */
  getStoredValues(withOrder?: boolean): GodotDictionary<any>;
}
