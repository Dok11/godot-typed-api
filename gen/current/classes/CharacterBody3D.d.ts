import type { GodotArray, GodotDictionary, KinematicCollision3D, PhysicsBody3D, Vector3, float, int } from "../index.d.ts";
/**
 ...
 * @returns float
 */
  getFloorAngle(upDirection?: Vector3): float;
/**
 ...
 * @returns KinematicCollision3D
 */
  getSlideCollision(slideIdx: int): KinematicCollision3D;
/**
