import type { Color, GodotArray, GodotDictionary, NavigationPathQueryResult3D, Node, PackedVector3Array, RID, Signal, Vector3, float, int } from "../index.d.ts";
/**
 ...
 * @returns NavigationPathQueryResult3D
 */
 ...
 */
  velocityComputed: Signal<[safeVelocity: Vector3]>;
/**
