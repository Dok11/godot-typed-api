import type { Color, GodotArray, GodotDictionary, NavigationPathQueryResult2D, Node, PackedVector2Array, RID, Signal, Vector2, float, int } from "../index.d.ts";
/**
 ...
 */
  pathMaxDistance: float;
/**
 * Additional information to return with the navigation path.
 */
  pathMetadataFlags: int;
/**
 ...
 * @param maskNumber int
 * @returns boolean
 */
  getAvoidanceMaskValue(maskNumber: int): boolean;
/**
 ...
 * @returns int
 */
  getCurrentNavigationPathIndex(): int;
/**
 * Returns the path query result for the path the agent is currently following.
 * @returns NavigationPathQueryResult2D
 */
 ...
 * @param value boolean
 */
  setAvoidanceMaskValue(maskNumber: int, value: boolean): void;
/**
 ...
 */
  linkReached: Signal<[details: GodotDictionary<any>]>;
/**
 ...
 */
  velocityComputed: Signal<[safeVelocity: Vector2]>;
/**
 ...
 */
  waypointReached: Signal<[details: GodotDictionary<any>]>;
}
