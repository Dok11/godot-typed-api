import type { Callable, GodotArray, GodotDictionary, Object, Signal, StringName, Variant, float, int } from "../index.d.ts";
/**
 ...
 * 
 */
export class UndoRedo extends Object {
/**
 ...
 */
  clearHistory(increaseVersion?: boolean): void;
/**
 ...
 */
  createAction(name: string, mergeMode?: int, backwardUndoOps?: boolean): void;
/**
