import type { Callable, GodotArray, GodotDictionary, NavigationMesh, NavigationMeshSourceGeometryData3D, Node, Object, float, int } from "../index.d.ts";
/**
 ...
 */
export class NavigationMeshGenerator extends Object {
/**
 ...
 */
  bake(navigationMesh: NavigationMesh, rootNode: Node): void;
/**
 ...
 * @param navigationMesh NavigationMesh
 */
  clear(navigationMesh: NavigationMesh): void;
/**
