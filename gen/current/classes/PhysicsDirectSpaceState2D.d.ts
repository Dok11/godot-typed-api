import type { Dictionary, GodotArray, GodotDictionary, Object, PackedFloat32Array, PhysicsPointQueryParameters2D, PhysicsRayQueryParameters2D, PhysicsShapeQueryParameters2D, Vector2, float, int } from "../index.d.ts";
/**
 ...
 */
export class PhysicsDirectSpaceState2D extends Object {
/**
 ...
 * @returns Vector2[]
 */
  collideShape(parameters: PhysicsShapeQueryParameters2D, maxResults?: int): Vector2[];
/**
 ...
 */
  getRestInfo(parameters: PhysicsShapeQueryParameters2D): GodotDictionary<any>;
/**
 ...
 * @returns Dictionary[]
 */
  intersectPoint(parameters: PhysicsPointQueryParameters2D, maxResults?: int): Dictionary[];
/**
 ...
 * @returns GodotDictionary<any>
 */
  intersectRay(parameters: PhysicsRayQueryParameters2D): GodotDictionary<any>;
/**
 ...
 * @returns Dictionary[]
 */
  intersectShape(parameters: PhysicsShapeQueryParameters2D, maxResults?: int): Dictionary[];
}
