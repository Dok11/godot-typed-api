import type { GodotArray, GodotDictionary, Node, Node2D, PhysicsBody2D, PhysicsDirectBodyState2D, PhysicsMaterial, RID, Signal, Vector2, float, int } from "../index.d.ts";
/**
 ...
 * @param impulse Vector2 (optional, default: Vector2(0, 0))
 */
 ...
 */
  private integrateForces(state: PhysicsDirectBodyState2D): void;
/**
