import type { GodotArray, GodotDictionary, Object, PhysicsDirectSpaceState2D, RID, Transform2D, Vector2, float, int } from "../index.d.ts";
/**
 ...
 */
export class PhysicsDirectBodyState2D extends Object {
/**
 ...
 * @param force Vector2 (optional, default: Vector2(0, 0))
 */
 ...
 */
  addConstantForce(force: Vector2, position?: Vector2): void;
/**
 * Adds a constant rotational force without affecting position that keeps being applied over time until cleared with `constant_torque = 0`.
 * @param torque float
 */
  addConstantTorque(torque: float): void;
/**
 ...
 * @param position Vector2 (optional, default: Vector2(0, 0))
 */
  applyForce(force: Vector2, position?: Vector2): void;
/**
 ...
 * @param position Vector2 (optional, default: Vector2(0, 0))
 */
  applyImpulse(impulse: Vector2, position?: Vector2): void;
/**
 ...
 * @returns Vector2
 */
  getContactColliderPosition(contactIdx: int): Vector2;
/**
 ...
 * @returns Vector2
 */
  getContactImpulse(contactIdx: int): Vector2;
/**
 * Returns the local normal at the contact point.
 * @param contactIdx int
 * @returns Vector2
 */
  getContactLocalNormal(contactIdx: int): Vector2;
/**
 * Returns the position of the contact point on the body in the global coordinate system.
 * @param contactIdx int
 * @returns Vector2
 */
  getContactLocalPosition(contactIdx: int): Vector2;
/**
 ...
 * @returns Vector2
 */
  getContactLocalVelocityAtPosition(contactIdx: int): Vector2;
/**
 ...
 * @param torque float
 */
  setConstantTorque(torque: float): void;
}
