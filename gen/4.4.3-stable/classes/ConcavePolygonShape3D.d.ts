import type { GodotArray, GodotDictionary, PackedVector3Array, Shape3D, float, int } from "../index.d.ts";
/**
 ...
 */
  setFaces(faces: PackedVector3Array): void;
}
