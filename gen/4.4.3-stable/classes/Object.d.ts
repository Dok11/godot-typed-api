import type { Callable, Dictionary, GodotArray, GodotDictionary, NodePath, Signal, StringName, Variant, float, int } from "../index.d.ts";
/**
 ...
 */
  addUserSignal(signal: string, arguments?: GodotArray<any>): void;
/**
 ...
 * @returns Variant
 */
  callDeferred(method: StringName): Variant;
/**
 ...
 * **Note:** In C#, `method` must be in snake_case when referring to built-in Godot methods. Prefer using the names exposed in the `MethodName` class to avoid allocating a new `StringName` on each call.
 * @param method StringName
 * @param argArray GodotArray<any>
 * @returns Variant
 */
  callv(method: StringName, argArray: GodotArray<any>): Variant;
/**
 ...
 * A signal can only be connected once to the same `Callable`. If the signal is already connected, this method returns `ERR_INVALID_PARAMETER` and pushes an error message, unless the signal is connected with `CONNECT_REFERENCE_COUNTED`. To prevent this, use `is_connected` first to check for existing connections.
 ...
 * @returns int
 */
  emitSignal(signal: StringName): int;
/**
 ...
 * @returns Variant
 */
  get_(property: StringName): Variant;
/**
 ...
 * @returns Variant
 */
  private get_(property: StringName): Variant;
/**
 ...
 * @param propertyPath NodePath
 * @returns Variant
 */
  getIndexed(propertyPath: NodePath): Variant;
/**
 ...
 * @returns Variant
 */
  getMeta(name: StringName, default_?: Variant): Variant;
/**
 ...
 * @returns int
 */
  getMethodArgumentCount(method: StringName): int;
/**
 ...
 * @returns Variant
 */
  private iterGet(iter: Variant): Variant;
/**
 ...
 * ```
 * 
 * **Note:** Alternatively, you can ignore `iter` and use the object's state instead, see online docs (https://docs.godotengine.org/en/stable/tutorials/scripting/gdscript/gdscript_advanced.html#custom-iterators) for an example. Note that in this case you will not be able to reuse the same iterator instance in nested loops. Also, make sure you reset the iterator state in this method if you want to reuse the same instance multiple times.
 * @param iter GodotArray<any>
 * @returns boolean
 */
  private iterInit(iter: GodotArray<any>): boolean;
/**
 ...
 * @returns boolean
 */
  private iterNext(iter: GodotArray<any>): boolean;
/**
 ...
 * 
 * @param what int
 * @param reversed boolean (optional, default: false)
 */
 ...
 * @param what int
 */
  private notification(what: int): void;
/**
 ...
 * @returns boolean
 */
  private propertyCanRevert(property: StringName): boolean;
/**
 ...
 * @returns Variant
 */
  private propertyGetRevert(property: StringName): Variant;
/**
 ...
 * @param value Variant
 */
  set_(property: StringName, value: Variant): void;
/**
 ...
 * @returns boolean
 */
  private set_(property: StringName, value: Variant): boolean;
/**
 ...
 * @param value Variant
 */
  setDeferred(property: StringName, value: Variant): void;
/**
 ...
 * @param value Variant
 */
  setIndexed(propertyPath: NodePath, value: Variant): void;
/**
 ...
 * @param value Variant
 */
  setMeta(name: StringName, value: Variant): void;
/**
 ...
 * @param script Variant
 */
  setScript(script: Variant): void;
/**
 ...
 * @returns string
 */
  trN(message: StringName, pluralMessage: StringName, n: int, context?: StringName): string;
/**
 ...
 * ```
 * 
 * @param property GodotDictionary<any>
 */
  private validateProperty(property: GodotDictionary<any>): void;
/**
