import type { Color, GodotArray, GodotDictionary, Texture2D, Vector3, VisualInstance3D, float, int } from "../index.d.ts";
/**
 ...
 * @returns Texture2D
 */
  getTexture(type_: int): Texture2D;
/**
 ...
 */
  setTexture(type_: int, texture: Texture2D): void;
/**
