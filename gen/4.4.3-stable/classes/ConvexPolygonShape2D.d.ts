import type { GodotArray, GodotDictionary, PackedVector2Array, Shape2D, float, int } from "../index.d.ts";
/**
 ...
 * @param pointCloud PackedVector2Array
 */
  setPointCloud(pointCloud: PackedVector2Array): void;
}
