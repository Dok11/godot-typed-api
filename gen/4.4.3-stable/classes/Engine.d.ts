import type { Dictionary, GodotArray, GodotDictionary, MainLoop, Object, PackedStringArray, ScriptLanguage, StringName, float, int } from "../index.d.ts";
/**
 ...
 * If `ProjectSettings.display/window/vsync/vsync_mode` is **Enabled**, on monitors with variable refresh rate enabled (G-Sync/FreeSync), using an FPS limit a few frames lower than the monitor's refresh rate will reduce input lag while avoiding tearing (https://blurbusters.com/howto-low-lag-vsync-on/).
 ...
 */
  getAuthorInfo(): GodotDictionary<any>;
/**
 ...
 * @returns GodotDictionary<any>
 */
  getDonorInfo(): GodotDictionary<any>;
/**
 ...
 * @returns GodotDictionary<any>
 */
  getLicenseInfo(): GodotDictionary<any>;
/**
 ...
 * @returns int
 */
  getPhysicsFrames(): int;
/**
 * Returns the fraction through the current physics tick we are at the time of rendering the frame. This can be used to implement fixed timestep interpolation.
 * @returns float
 */
  getPhysicsInterpolationFraction(): float;
/**
 ...
 * @returns GodotDictionary<any>
 */
  getVersionInfo(): GodotDictionary<any>;
/**
 ...
 * @returns boolean
 */
  hasSingleton(name: StringName): boolean;
/**
 ...
 * ```
 * 
 * See Running code in the editor (https://docs.godotengine.org/en/stable/tutorials/plugins/running_code_in_the_editor.html) in the documentation for more information.
 * 
 ...
 * @returns int
 */
  registerScriptLanguage(language: ScriptLanguage): int;
/**
 * Registers the given `Object` `instance` as a singleton, available globally under `name`. Useful for plugins.
 * @param name StringName
 * @param instance Object
 */
  registerSingleton(name: StringName, instance: Object): void;
/**
 ...
 * @returns int
 */
  unregisterScriptLanguage(language: ScriptLanguage): int;
/**
 ...
 * @param name StringName
 */
  unregisterSingleton(name: StringName): void;
}
