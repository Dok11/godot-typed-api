import type { GodotArray, GodotDictionary, PacketPeerDTLS, PacketPeerUDP, RefCounted, TLSOptions, float, int } from "../index.d.ts";
/**
 ...
 * @returns int
 */
  setup(serverOptions: TLSOptions): int;
/**
 ...
 * @param udpPeer PacketPeerUDP
 * @returns PacketPeerDTLS
 */
  takeConnection(udpPeer: PacketPeerUDP): PacketPeerDTLS;
}
