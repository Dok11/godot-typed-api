import type { CollisionObject3D, Color, GodotArray, GodotDictionary, Node3D, Object, RID, Resource, Shape3D, Vector3, float, int } from "../index.d.ts";
/**
 ...
 * @returns Vector3
 */
  getCollisionNormal(index: int): Vector3;
/**
 ...
 * @returns Vector3
 */
  getCollisionPoint(index: int): Vector3;
/**
