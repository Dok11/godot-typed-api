import type { Callable, GodotArray, GodotDictionary, RefCounted, Variant, float, int } from "../index.d.ts";
/**
 ...
 */
  setThreadSafetyChecksEnabled(enabled: boolean): void;
/**
 ...
 * @param priority int (optional, default: 1)
 * @returns int
 */
