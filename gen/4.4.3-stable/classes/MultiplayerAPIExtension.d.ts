import type { GodotArray, GodotDictionary, MultiplayerAPI, MultiplayerPeer, Object, PackedInt32Array, StringName, Variant, float, int } from "../index.d.ts";
/**
 ...
 * @returns MultiplayerPeer
 */
  private getMultiplayerPeer(): MultiplayerPeer;
/**
 * Callback for `MultiplayerAPI.get_peers`.
 * @returns PackedInt32Array
 */
  private getPeerIds(): PackedInt32Array;
/**
 * Callback for `MultiplayerAPI.get_remote_sender_id`.
 * @returns int
 */
  private getRemoteSenderId(): int;
/**
 ...
 * @returns int
 */
  private objectConfigurationAdd(object: Object, configuration: Variant): int;
/**
 ...
 * @returns int
 */
  private objectConfigurationRemove(object: Object, configuration: Variant): int;
/**
 ...
 * @returns int
 */
  private rpc(peer: int, object: Object, method: StringName, args: GodotArray<any>): int;
/**
 * Called when the `MultiplayerAPI.multiplayer_peer` is set.
 * @param multiplayerPeer MultiplayerPeer
 */
  private setMultiplayerPeer(multiplayerPeer: MultiplayerPeer): void;
}
