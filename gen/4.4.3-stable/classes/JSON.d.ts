 ...
 * @returns Variant
 */
  fromNative(variant: Variant, fullObjects?: boolean): Variant;
/**
 ...
 * @param keepText boolean (optional, default: false)
 * @returns int
 */
  parse(jsonText: string, keepText?: boolean): int;
/**
 * Attempts to parse the `json_string` provided and returns the parsed data. Returns `null` if parse failed.
 * @param jsonString string
 * @returns Variant
 */
  parseString(jsonString: string): Variant;
/**
 ...
 * ```
 * @param data Variant
 * @param indent string (optional, default: "")
 * @param sortKeys boolean (optional, default: true)
 * @param fullPrecision boolean (optional, default: false)
 * @returns string
 */
  stringify(data: Variant, indent?: string, sortKeys?: boolean, fullPrecision?: boolean): string;
/**
 ...
 * @returns Variant
 */
  toNative(json: Variant, allowObjects?: boolean): Variant;
}
