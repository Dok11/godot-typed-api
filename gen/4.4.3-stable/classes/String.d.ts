 ...
 * ```
 * @param number_ float
 * @param decimals int (optional, default: -1)
 * @returns string
 */
  num(number_: float, decimals?: int): string;
/**
 ...
 * @param number_ int
 * @param base int (optional, default: 10)
 * @param capitalizeHex boolean (optional, default: false)
 * @returns string
 */
  numInt64(number_: int, base?: int, capitalizeHex?: boolean): string;
/**
 ...
 * @returns string
 */
  numScientific(number_: float): string;
/**
 ...
 * @returns string
 */
  numUint64(number_: int, base?: int, capitalizeHex?: boolean): string;
/**
